...
<body class="bg-white text-white font-sans">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-envelope-open-heart me-2" viewBox="0 0 16 16">
    ...
    <!-- Main Content -->
    <main class="flex flex-col min-vh-100">
